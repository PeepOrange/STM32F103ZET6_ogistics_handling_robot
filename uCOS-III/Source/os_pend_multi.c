...
*                                message queue) to pend on.         //要等待的内核对象（一般为数组） 
*
*                                    OS_PEND_DATA  MyPendArray[?];
*                                    例：
*                                         OS_PEND_DATA  MyPendArray[2] 
*                                         MyPendArray[0].PendObjPtr=&sem;
*                                         MyPendArray[0].PendObjPtr=&queue;
*
...
*                            then you would pass 4 to this call.    //等待对象的数目
*
