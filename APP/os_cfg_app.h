...
#define  OS_CFG_STAT_TASK_STK_SIZE       128u               /* Stack size (number of CPU_STK elements)                */
                                                            ...
                                                            /* ------------------------ TICKS ----------------------- */
#define  OS_CFG_TICK_RATE_HZ            1000u               /* 时钟节拍频率(10 to 1000 Hz)  1KHZ，即1ms                */
#define  OS_CFG_TICK_TASK_PRIO            10u               /* 时钟节拍任务优先级 OS_TickTask()                        */
#define  OS_CFG_TICK_TASK_STK_SIZE       128u               /* 时钟节拍任务栈空间大小              */
#define  OS_CFG_TICK_WHEEL_SIZE           17u               /* OSCfg_TickWheel 数组的大小，推荐任务总数/4，且为质数   */


                                                            /* ----------------------- TIMERS ----------------------- */
#define  OS_CFG_TMR_TASK_PRIO             11u               /* 定时器任务的优先级                             */
#define  OS_CFG_TMR_TASK_RATE_HZ          10u               /* 定时器的时基（不能大于 OS_CFG_TICK_RATE_HZ ）                        */
#define  OS_CFG_TMR_TASK_STK_SIZE        128u               /* 定时器任务的栈空间大小  （单位：CPU_STK）            */
#define  OS_CFG_TMR_WHEEL_SIZE            17u               /* OSCfg_TmrWheel 数组的大小，推荐任务总数/4，且为质数    */
